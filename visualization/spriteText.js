...
export function generateTextSprite(text, config) {
    ...
    var borderThickness = config.hasOwnProperty('borderThickness') ? config['borderThickness'] : 10;
    var borderColor = config.hasOwnProperty('borderColor') ? config['borderColor'] : 'rgba(0, 0, 0, 1)';
    var borderRadius = config.hasOwnProperty('borderRadius') ? config['borderRadius'] : 10;
    var backgroundColor = config.hasOwnProperty('backgroundColor') ? config['backgroundColor'] : 'rgba(0, 0, 0, 0.8)';
